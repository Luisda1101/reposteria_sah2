        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted">Cliente desde
                        <?php echo date('d/m/Y', strtotime($cliente['fecha_registro'])); ?></p>
                </div>
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php echo $stats['total_pedidos'] ?? 0; ?></div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                            Total Gastado</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            $<?php echo number_format($stats['total_gastado'] ?? 0, 2); ?></div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            $<?php echo number_format($stats['promedio_pedido'] ?? 0, 2); ?></div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <?php if (mysqli_num_rows($result_pedidos) > 0): ?>
                                <?php while ($pedido = mysqli_fetch_assoc($result_pedidos)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../pedidos/ver.php?id=<?php echo $pedido['id_pedido']; ?>"
                        ...
                        <div id="productos-container">
                            <div class="row producto-row mb-3">
                                ...
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <span class="input-group-text">$</span>
                                        <input type="number" class="form-control subtotal-input" name="subtotales[]"
                                            placeholder="Subtotal" step="0.01" min="0" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
